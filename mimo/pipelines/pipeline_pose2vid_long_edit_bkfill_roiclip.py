...
from mimo.models.mutual_self_attention import ReferenceAttentionControl
from mimo.pipelines.context import get_context_scheduler
from mimo.pipelines.utils import get_tensor_interpolation_method
    ...
    def __call__(
        ...
        **kwargs,
        ...
        for vid_bk_image in vid_bk_images:
            vid_bk_image_tensor = self.ref_image_processor.preprocess(
                vid_bk_image, height=height, width=width
            )
            vid_bk_image_tensor = vid_bk_image_tensor.to(
                dtype=self.vae.dtype, device=self.vae.device
            )
            ...
            for i, t in enumerate(timesteps):
                ...
                for context in global_context:
                    ...
                    latent_model_input = torch.cat(
                        [latent_model_input, latent_vid_bk_input], dim=1
                    )
