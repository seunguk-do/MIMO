...
prj_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath(__file__))))
# CACHE_DIR = os.path.join(os.environ.get("HOME"), ".cache")
# CACHE_DIR_4DHUMANS = os.path.join(CACHE_DIR, "4DHumans")
CACHE_DIR_4DHUMANS = os.path.join(prj_dir, "assets")
    ...
    if update_cachedir:
        ...
        def update_path(path: str) -> str:
            if os.path.isabs(path):
                return path
            return os.path.join(os.environ["DATA_DIR"], "video_decomp", path)
