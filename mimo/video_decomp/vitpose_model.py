...
VIT_DIR = os.path.join(ROOT_DIR, "mimo/video_decomp/third-party/ViTPose")
...
class ViTPoseModel(object):
    MODEL_DICT = {
        "ViTPose+-G (multi-task train, COCO)": {
            ...
            "model": f"{ROOT_DIR}/data/video_decomp/models/vitpose_ckpts/vitpose+_huge/wholebody.pth",
        },
    }
